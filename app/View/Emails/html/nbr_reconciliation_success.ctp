<!-- when reconciliation between Connect & NBR is successful -->
<div>
        Hi Global,
</div>
<br/>
<div>
        This is to inform you that, data reconciliation between Connect and NBRT systems completed successfully. Please find detailed report below,
</div>
<br/>
<div>
