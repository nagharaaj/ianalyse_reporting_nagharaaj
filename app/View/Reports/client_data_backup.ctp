    <script type="text/javascript">
         $(document).ready(function () {
             ...
             var stages = ['Live - aggressive', 'Live - defensive', 'Lost - current client', 'Lost - new business', 'Won - new business', 'Won - retained', 'Current client'];
             ...
             $("#dataTable").jqxDataTable(
             {
                    ...
                    if ($(".editButtons").length > 0) {
                        ...
                        var editClick = function (event) {
                            ...
                            if (value == "Edit") {
                                ...
                                $("#update_pitchstage").jqxDropDownList({ source: ['Live - aggressive', 'Live - defensive', 'Lost - current client', 'Lost - new business', 'Won - new business', 'Won - retained', 'Current client'] }).val(pitchstage);
                                ...
                                $("#update_region").bind('select', function (event) {
                                    ...
                                    if(item != null) {
                                        arrCountries = markets[item.label];
                                        $("#update_nameofentity").jqxDropDownList({ source: arrCountries, checkboxes: false, selectedIndex: -1 });
                                    }
                                });
                ...
                columns: [
                  ...
                  { text: 'Country', datafield: 'Country', width: 120, cellClassName: cellclass, editable: false },
                  { text: 'City', datafield: 'City', width: 120, cellClassName: cellclass, editable: false },
                  ...
                  { text: 'Status', datafield: 'PitchStage', width: 130, cellClassName: cellclass },
                  ...
                  { text: 'Lost Since (M-Y)', datafield: 'Lost', width: 100, cellClassName: cellclass },
                  { text: 'Pitched (M-Y)', datafield: 'PitchStart', width: 100, cellClassName: cellclass },
                  ...
                  { text: 'iP estimated revenue', columngroup: 'EstimatedRevenue', datafield: 'EstimatedRevenue', width: 130, align: 'center', cellsalign: 'right', cellClassName: cellclass, cellsFormat: 'f2' },
                  { text: 'iP 2014 Actual revenue', columngroup: 'ActualRevenue', datafield: 'ActualRevenue', width: 150, align: 'center', cellsalign: 'right', cellClassName: cellclass, cellsFormat: 'f2' },
            ...
            $("#createNew").click(function () {
                ...
                $("#pitchstage").jqxDropDownList({ source: ['Live - aggressive', 'Live - defensive', 'Lost - current client', 'Lost - new business', 'Won - new business', 'Won - retained', 'Current client'], selectedIndex: -1 });
                ...
                $("#region").bind('select', function (event) {
                    ...
                    if(item != null) {
                        arrCountries = markets[item.label];
                        $("#nameofentity").jqxDropDownList({ source: arrCountries, checkboxes: false, selectedIndex: -1 });
                    }
                });
